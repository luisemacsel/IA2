...
(:predicates
	(orientacion ?o)
	(feature ?f)    ;operacion a realizar ejemplo s1 ,s2
    (tipo ?t)       ;tipo de operacion ej agujero
    (operacion ?op) ;tipo de maquina que se utiliza
    (feature-tipo ?f ?feat-tipo) ;combinacion de 5 y 6
    (orientacion-pieza ?oa)
    (orientacion-feature ?f ?oa) ;orientacion de la operacion
